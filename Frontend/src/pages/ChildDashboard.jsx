...
// Using simple emoji/text icons as placeholders for the actual SVGs or image assets, matching the design.
        ...
        <div className="cd-card cd-welcome">
          <div className="cd-welcome-left">
            ...
            <div className="cd-welcome-text">
              ...
              <p>Goal: Improve pronunciation & finish 5 stories this week</p>
            </div>
          </div>
