import{h as e,r as t,c as r,F as n,g as i}from"./p-BegYsW3e.js";const u=(t,r)=>{const n=t.outline?"material-icons-outlined":"material-icons";delete t.outline;return e("i",Object.assign({class:n},t),r)};const a=class{constructor(e){t(this,e);this.expired=r(this,"expired");this.timeout=0;this.timer=0;this.open=true}componentDidLoad(){if(this.timeout<=0){return}this.timer=setTimeout((()=>{this.timer=0;this.expired.emit();this.open=false}),this.timeout)}disconnectedCallback(){this.open=false;if(this.timer){clearTimeout(this.timer);this.timer=0}}render(){if(!this.open){return}return e("p",{"data-test-id":this.data_cy,class:"alert status-error"},e(u,null,"error_outline")," ",this.msg)}};a.style=`error-message {\n      display: block;\n    }`;var o=typeof globalThis!=="undefined"?globalThis:typeof window!=="undefined"?window:typeof global!=="undefined"?global:typeof self!=="undefined"?self:{};var f={};
/*!
 *  howler.js v2.2.4
 *  howlerjs.com
 *
