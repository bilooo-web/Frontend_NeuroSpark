  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: `${buttonStyles("outline")} h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100`,
        ...
        day: `${buttonStyles()} h-9 w-9 p-0 font-normal aria-selected:opacity-100`,
