        ...
        {data && data.length > 0 ? (
          <ResponsiveContainer width="100%" height={240}>
            <AreaChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
              ...
              />
              <Area type="monotone" dataKey="sessions" stroke="#7C3AED" strokeWidth={3} fill="url(#gradientSessions)" dot={false} activeDot={{ r: 5, fill: '#7C3AED', strokeWidth: 0 }} name="Sessions" />
            </AreaChart>
          </ResponsiveContainer>
        ) : (
