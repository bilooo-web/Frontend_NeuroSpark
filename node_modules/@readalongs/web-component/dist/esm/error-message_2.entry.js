import { h, r as registerInstance, c as createEvent, F as Fragment, g as getElement } from './index-BegYsW3e.js';
...
const MatIcon = (props, children) => {
    ...
    return (h("i", Object.assign({ class: iconType }, props), children));
};

const ErrorMessage = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.expired = createEvent(this, "expired");
        /**
...
const web_component$1 = {
	...
	"loading-error": "Erreur: le fichier <FILETYPE> \"<FILENAME>\" n'a pas pu être chargé.",
	"parse-error": "Erreur: le fichier <FILETYPE> \"<FILENAME>\" n'a pas pu être analysé.",
	...
	"configuration-tooltip": "Préférences",
	settings: "Mes préférences",
	"page-animation": "Transitions de page animées",
	"auto-pause": "Pause à la fin de chaque page",
	language: "Langue de l'interface",
	"save-settings": "Sauvegarder mes préférences",
	"reset-title": "Réinitialiser toutes les préférences",
	reset: "Réinitialiser",
	eng: "Anglais",
	fra: "Français",
	spa: "Espagnol",
...
const web_component = {
	...
	"play-tooltip": "Reproducir/pausar grabación de audio",
	...
	"page-animation": "Transiciónes de página animadas",
	"auto-pause": "Pausa al final de cada página",
...
export { ErrorMessage as error_message, ReadAlongComponent as read_along };
//# sourceMappingURL=error-message.read-along.entry.js.map

//# sourceMappingURL=error-message_2.entry.js.map