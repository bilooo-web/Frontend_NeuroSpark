 ...
 */
export async function parseRAS(path) {
 ...
 */
export function extractMeta(xml) {
    let meta = {};
 ...
 */
export function extractAlignment(parsed_text) {
    let alignment = {};
...
export var Sprite = function (options) {
    ...
    // percentage finished
    self._percentPlayed = new BehaviorSubject("0%");
...
export const setUserPreferences = (userPref) => {
...
export const sentenceIsAligned = (sentence) => {
