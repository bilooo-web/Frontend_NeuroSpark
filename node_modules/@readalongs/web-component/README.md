...
See for example the unit testing file [test-data/ej-fra/index.html](https://github.com/ReadAlongs/Studio-Web/blob/${GITHUB_REF_NAME}/packages/web-component/test-data/ej-fra/index.html), which assumes this Stencil component is being served on port 3333, the default when running locally.
