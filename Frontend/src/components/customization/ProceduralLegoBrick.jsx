...
const ProceduralLegoBrick = ({
  ...
  const FallbackBrick = () => {
    ...
    const dims = {
      ...
      // 1×N bricks (1 brick = 3 plates = 3×0.22 = 0.66)
      '3005': [0.55, 0.66, 0.55],   // Brick 1×1
      '3004': [1.10, 0.66, 0.55],   // Brick 1×2
      '3622': [1.65, 0.66, 0.55],   // Brick 1×3
      '3010': [2.20, 0.66, 0.55],   // Brick 1×4
      '3009': [3.30, 0.66, 0.55],   // Brick 1×6
      '3008': [4.40, 0.66, 0.55],   // Brick 1×8
      // 2×N bricks
      '3003': [1.10, 0.66, 1.10],   // Brick 2×2
      '3002': [1.65, 0.66, 1.10],   // Brick 2×3
      '3001': [2.20, 0.66, 1.10],   // Brick 2×4
      // Slopes/specials
      '54200': [0.55, 0.22, 0.55],
      '85984': [1.10, 0.22, 0.55],
      '3040b': [1.10, 0.44, 0.55],  // 2 plates tall
      '15068': [1.10, 0.22, 1.10],
      '93273': [2.20, 0.22, 0.55],
      '11477': [1.10, 0.22, 0.55],
      '4073':  [0.55, 0.22, 0.55],
      '98138': [0.55, 0.22, 0.55],
      '3070b': [0.55, 0.22, 0.55],
      '3069b': [1.10, 0.22, 0.55],
      '2412b': [1.10, 0.22, 0.55],
    };
